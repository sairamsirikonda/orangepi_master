...
def read_float_from_modbus(address, slave):
    try:
        ...
        # Modbus request: read input registers (function code 0x04)
        ...
        command_to_send = struct.pack('>BBBBHH', slave, 0x04, (address - 1) >> 8, (address - 1) & 0xFF, 0x00, 0x02)  # 0x00, 0x02 = read 2 registers (32-bit float)
